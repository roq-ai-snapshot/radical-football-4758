...
function TeamListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<TeamInterface[]>(
    ...
    () =>
      getTeams({
        relations: ['academy', 'coach_team.count', 'player.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('coach_team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>coach_team</Th>}
                ...
                {data?.map((record) => (
                  <Tr key={record.id}>
                    ...
                    {hasAccess('coach_team', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.coach_team}</Td>
                    )}
