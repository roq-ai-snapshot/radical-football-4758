              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr key={record.id}>
                    ...
                    {hasAccess('training_program', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/training-programs/view/${record.training_program?.id}`}>
                    ...
                    {hasAccess('player_training_program', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <NextLink href={`/player-training-programs/edit/${record.id}`} passHref legacyBehavior>
                    ...
                    {hasAccess('player_training_program', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <NextLink href={`/player-training-programs/view/${record.id}`} passHref legacyBehavior>
