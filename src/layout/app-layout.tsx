...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Coach Team', path: '/coach-teams', entity: 'coach_team', service: AccessServiceEnum.PROJECT, icon: FiBox },
  {
    name: 'Parent Child',
  ...
  {
    name: 'Player Training Program',
    path: '/player-training-programs',
